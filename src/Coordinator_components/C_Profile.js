...
const C_Profile = () => {
    ...
    let updatehadnel = (e) => {
        ...
        console.log(obj)
        axios.post("http://157.66.191.24:3051/user/api/updateCoordinatorProfile", formdata).then((res) => {
            console.log(res)
            if (res.data.result == "true") {
                                                            ...
                                                            <div className="p-2 theme-transparent-bg theme-border-radius text-center" >
                                                                {
                                                                    editprofiledata?.coordinatorProfile === " " || editprofiledata?.coordinatorProfile === null || editprofiledata?.coordinatorProfile === undefined ? (
                                                                        ...
                                                                        <img
                                                                            style={{ width: "75px", height: "75px" }}
                                                                            src={preview || `http://157.66.191.24:3051/uploads/${editprofiledata?.coordinatorProfile}`}
                                                                            alt="images"
                                                                            className="rounded-circle"
                                                                        />
                                                                    ) : (
