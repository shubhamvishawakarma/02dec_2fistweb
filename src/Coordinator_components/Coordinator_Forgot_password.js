...
const Coordinator_Forgot_password = () => {
    ...
    let handleFormValue = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            setloader(false)
            axios.post("http://157.66.191.24:3051/user/api/coordinatorForgotPassword", obj).then((res) => {
    ...
    let handle_reset_FormValue = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            axios.post("http://157.66.191.24:3051/user/api/coordinatorResetPassword", objdata).then((res) => {
